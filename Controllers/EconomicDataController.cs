...
namespace QuantResearchAgent.Controllers
{
    ...
    public class EconomicDataController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetOptionsData(string symbol)
        {
            try
            {
        ...
        public async Task<IActionResult> GetCommodityData(string commodity)
        {
            try
            {
        ...
        [HttpGet("forex/{pair}")]
        public async Task<IActionResult> GetForexData(string pair)
        {
            try
            {
