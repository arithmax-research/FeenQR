...
public class AgentOrchestrator
{
    ...
    private readonly ArxivResearchAgentService _arxivResearchAgent;
    ...
    public AgentOrchestrator(
        Kernel kernel,
        PodcastAnalysisService podcastService,
        TradingSignalService signalService,
        MarketDataService marketDataService,
        RiskManagementService riskService,
        PortfolioService portfolioService,
        ArxivResearchAgentService arxivResearchAgent,
        ...
        ILogger<AgentOrchestrator>? logger = null)
    {
        ...
        _arxivResearchAgent = arxivResearchAgent;
        ...
        _dataRefreshTimer = null;
            ...
            kernel.Plugins.AddFromObject(new ArxivResearchPlugin(_arxivResearchAgent));
    ...
    private void RegisterPlugins()
    {
        try
        {
            ...
            _kernel.Plugins.AddFromType<ArxivResearchPlugin>();
    ...
    {
        var podcastUrl = job.Parameters["podcastUrl"].ToString()!;
        var episode = await _podcastService.AnalyzePodcastAsync(podcastUrl);
        
        // Generate trading signals from podcast insights
        var signals = await _signalService.GenerateSignalsFromPodcastAsync(episode);
        
        return $"Analyzed podcast: {episode.Name}. Generated {signals.Count} trading signals.";
    }
